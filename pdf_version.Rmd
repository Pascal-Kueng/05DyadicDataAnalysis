...
**Suggested citation:** Küng, P. M. (2026). *Distinguishable and Exchangeable Dyads: Bayesian Multilevel Modelling*. University of Zurich. DOI: 10.5281/zenodo.17400655

> **Full GitHub repository:**
> The full repository contains the tutorial source files, reusable helper
> functions, model code, rendered quick guides, and additional information:
...
- Actor and partner predictors can be rewritten as a dyad-level mean and a within-dyad deviation (half-difference).
