...
The simplified intensive-longitudinal specification used here models
...
- stable between-dyad differences in each role's average level and time trend;
...
dist_example <- df_long_apim |>
  select(
    userID, diaryday, .is_female, .is_male,
    .provided_support_cwp_actor, .provided_support_cwp_partner
  )

kable(
  dist_example,
  caption = "Prepared rows for a distinguishable dyad",
  booktabs = TRUE
) |>
...
between-person actor-partner predictors used below.
