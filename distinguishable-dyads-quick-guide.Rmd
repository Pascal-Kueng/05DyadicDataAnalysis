...
`prepare_interdep_data()` creates the role indicators and the within-person and
between-person actor-partner predictors. The tutorial helper drops the `.i_`
prefix while retaining names such as `cwp_actor` and `cbp_partner`.
