...
Residual variance in `nlme` must first be constructed from the output by taking the residual and multiply it with the parameter estimates under the variance function for each partner. 
...
Manually computed by multiplying the residual with the mulitpliers:
