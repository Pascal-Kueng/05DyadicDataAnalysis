...
model_apim_ind_long_glmmTMB <- glmmTMB(
  closeness ~ 1 + 
    ...
    # Option 2: equivalent sum/difference parameterization.
    # This would need to be rotated back for clean interpretation:
...
priors <- c(
  ...
  # We could set priors for other things, but brms sets sensible default priors
