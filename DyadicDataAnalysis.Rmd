...
A dynamic MLM can account for temporal dependence by including lagged outcomes as predictors. In dyadic data, this can include actor inertia and partner spillover: today's closeness is predicted by yesterday's own closeness and yesterday's partner closeness, in addition to the concurrent APIM predictors.
