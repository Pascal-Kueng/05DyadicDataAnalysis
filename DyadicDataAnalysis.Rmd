...
* [Distinguishable dyads quick guide](distinguishable_dyads_model_output.pdf)
* [Exchangeable dyads quick guide](exchangeable_dyads_backtransform.pdf)
...
```{r results-dist-long-ground-truth, echo = FALSE, cache=TRUE, dependson=c('fit-dist-apim-long-complex-brms', 'simulate-longitudinal-data', 'data-dist-long-apim-center')}
...
```{=html}
  ...
  <div id="sd2-coefs"
       data-b0="`r round(fixef(model_exch_apim)['Intercept','Estimate'], 2)`"
       data-ba="`r round(fixef(model_exch_apim)['communication_actor_gmc','Estimate'], 2)`"
       data-bp="`r round(fixef(model_exch_apim)['communication_partner_gmc','Estimate'], 2)`"></div>
...
print_df(as.data.frame(round(a$full_correlation_matrix, 3)))
```
